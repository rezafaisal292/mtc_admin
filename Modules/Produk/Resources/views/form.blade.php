...
$title = 'Tambah'; $method = 'post'; $action = 'produk.store';
if ($segment !== 'create' ) { $title = 'Ubah'; $method = 'put'; $action = ['produk.update', $d->id]; }
@endphp
@extends('adminlte::page')
@section('title', env('APP_NAME').'::'.$title.' Produk')
@section('content')
    ...
    <div class="card-body">
        <div class="form-group row">
            <div class="col-md-6">
                ...
                {{ Form::fgSelect('Services', 'services', $services,$d->services, ['class' => 'form-control'], null, 'text', true) }}
                {{ Form::fgSelect('Tipe Produk', 'tipe_produk',$tipe_produk ,$d->tipe_produk, ['class' => 'form-control'], null, 'text', true) }}
