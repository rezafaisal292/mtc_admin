...
$title = 'Tambah'; $method = 'post'; $action = 'pageweb.store';
if ($segment !== 'create' ) { $title = 'Ubah'; $method = 'put'; $action = ['pageweb.update', $d->id]; }
@endphp
@extends('adminlte::page')
@section('title', env('APP_NAME').'::'.$title.' Pageweb')
@section('content')
